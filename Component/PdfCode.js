...
<html>
  ...
  <body >
    ...
    <div class="data-title">
        ...
        font-size: 2rem;  
        padding-left: 20px;">Invoice For Monthly Expenses<br></div>
    <div style="
    display: flex;
    flex-direction: column;
    align-items: flex-start; 
    padding-left: 20px;
    ">Arihant Arden Noida</div>
    </div>
    ...
    width: 90px;
    margin-right:15px;
        " src="https://dynamic.realestateindia.com/proj_images/project6017/proj_header_image-6017-770x400.jpg" />
    </div>
    <hr />
        <hr/>
        <div style="
        ...
        align-items: center;">
            <table style="width:100%; border-collapse: collapse;">
                ...
                <!-- <div style="align-self: flex-end;margin-right: 10px;font-style: bold;">Received Amount :  1</div>
                ...
                <div style="width:40%"></div>
                  ...
                  <td style="text-align: center;height: 30px;">₹ ${Total}</td>
                        ...
                        <tr style="border-bottom: solid ;">
                            <th style="text-align: start;">Received Amount : </th>
        ...
        <div style="height:auto; padding: 20px;">
            ...
            Bank Name: HDFC BANK, Gurgaon<br/>
